...
### Intrinsic rewards:
  ...
  - In our algorithms, we follow the practice of [Burda et al., 2018](https://arxiv.org/pdf/1810.12894.pdf), [Badia et al., 2020](https://arxiv.org/pdf/2003.13350.pdf) and perform credit assignment and value estimation for each reward stream separately.
### Networks:
